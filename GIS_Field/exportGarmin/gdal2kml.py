...
def create_tile(source, filename, offset, size, quality=100):
    """
...
def create_kml(source, filename, directory, tile_size=1024, border=0, name=None, order=20, exclude=[], quality=100):
    """
